...
public class SimpleBoats implements ModInitializer
{
	public static final String MOD_ID = "simpleboats";
	...
	public void onInitialize()
    {
        ...
        SimpleBoatsEntities.initialize();
		SimpleBoatsItems.initialize();
